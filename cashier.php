  ...
  <div class="container  ">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
		...
		<a class="nav-link active" href="casier.php">Касири</a>
...
<div class="container text-center , containerr ">
		    <div class="row">
				...
				<div class="col-lg-6 mx-auto">
					...
					<img class= "rounded-img " src="cashier.jpg" alt="картинки не будет блєт"/>
					<h1 >КАСИРИ</h1>
					<h2>Ви доєдналися до таблиці касири</h2>
					<div class="container">

						<p class="lead text-muted col-lg-6 mx-auto">тут ви можете редагувати та змінювати данні таблиці Cashier </p>
					</div>
...
<form action="add_cashier.php" method="post">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        <label for="cashier_name" class="form-label">Ім'я</label>
        <input type="text" class="form-control" id="cashier_name" name="cashier_name" pattern="[a-zA-ZА-Яа-яЁёІіЇїЄєҐґ]+" placeholder="Ім'я">
      </div>
      <div class="mb-3">
...
<h1>Редагування</h1>
<form action="edit_cashier.php" method="post">
  <div class="card">
    <div class="card-header">
      Редагування
    </div>
...
<h1>Видалення</h1>
<form action="delete_cashier.php" method="post">
  <div class="card">
    <div class="card-header">
      Видалення
    </div>
...
<body>
    <h1>Список касирів</h1>
        ...
        <button id="toggleButton" onclick="toggleCarsVisibility()">Показати всіх касирів</button>
        ...
        <table>
            ...
            <tbody>
                <?php
                $result = mysqli_query($link, "SELECT * FROM cashier");
